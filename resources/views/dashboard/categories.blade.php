            ...
            <div class="bg-white overflow-hidden shadow-sm">
                ...
                <div class="overflow-x-auto">
                    <a href="{{ route('categories.create') }}"
                        ...
                        <span class="text-sm font-medium"> Dodaj novu kategoriju </span>
                        ...
                        @if ($categories)
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-left whitespace-nowrap px-4 py-2 font-medium text-gray-900">Slug
                                    </th>
                            ...
                            @forelse ($categories as $category)
                                <tr>
                                    ...
                                    <td class="whitespace-nowrap px-4 py-2 text-gray-700">
                                        <a class="underline" href="{{ route('products.category', $category->slug) }}">
                                            {{ $category->name }} </a>
                                    </td>
                                    ...
                                    <td class="whitespace-nowrap px-4 py-2 flex gap-3">
                                        ...
                                        <x-categories.delete-button id="{{ $category->id }}" />
                                    </td>
                                </tr>
                            @empty
                                <tr>
